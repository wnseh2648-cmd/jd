    ...
    with col_ml3:
        ...
        <div class="analysis-card" style="min-height: 280px;">
            ...
            <div class="analysis-content" style="font-size:0.9rem;">
                ...
                <b>1. 선형 회귀:</b> {optimal_lag_p}개월 전 금리 인상이 현재 가격 하락에 미치는 정확한 <b>방향성</b>을 추적합니다.<br><br>
                <b>2. 랜덤 포레스트:</b> 이 지역 집값을 결정하는 데 두 요인이 각각 <b>몇 %의 기여도(지분)</b>를 가지는지 절대적 파워를 분석합니다.
            </div>
        </div>
        """, unsafe_allow_html=True)
